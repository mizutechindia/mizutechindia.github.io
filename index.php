    ...
    <br><br><br>
        <div class="row">
            ...
            <div class="newsletter-form aos-init aos-animate">
                <form style="text-align: center;" action="mailto:info@technovita.in" method="post" enctype="text/plain">
                    <input class="email" type="email" placeholder="Ente your email" name="mail">
